...
public class Graph {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Graph graph = Graph.read("jazz.graph");
        graph.addEdges();
        double cutoff = 2.0;
        long randSeed = 2;
        
        System.out.println("Original vertex size: " +graph.getList().size());
        List<Vertex> finalSol = SA.SimulatedAnnealing(graph, cutoff, randSeed);
